...
public class WandOfDeath extends Wand {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World world, EntityLivingBase player) {
        ...
        playSound(SoundEvents.ENTITY_WITHER_SHOOT, world, player);
        if (!world.isRemote) {
            ...
            world.spawnEntity(new DeathSkull(world, player, player.posX + deltaX, player.posY + 1, player.posZ + deltaZ, vecX, vecY, vecZ));
        }
        return stack;
    }
}