...
public class TopHatRenderer extends ModelBiped  {
	...
	public ResourceLocation blackTexture = new ResourceLocation(WonderfulWandsOld.MODID+":textures/witchblack.png");
	public ResourceLocation whiteTexture = new ResourceLocation(WonderfulWandsOld.MODID+":textures/fancywhite.png");
